...
\vspace{-2ex}
\raggedbottom\lstinputlisting[style=cpp]{cpp/Math/ModSum.cpp}
\vspace{-3.2ex}
\hrulefill
\subsection{ModMulLL}
\vspace{-2ex}
\raggedbottom\lstinputlisting[style=cpp]{cpp/Math/ModMulLL.cpp}
\vspace{-3.2ex}
\hrulefill
\subsection{MillerRabin Primality check}
\vspace{-2ex}
\raggedbottom\lstinputlisting[style=cpp]{cpp/Math/MillerRabin.cpp}
\vspace{-3.2ex}
\hrulefill
\subsection{Pollard-rho randomized factorization algorithm ${O(n^{1/4})}$}
\vspace{-2ex}
\raggedbottom\lstinputlisting[style=cpp]{cpp/Math/Factor.cpp}
\vspace{-3.2ex}
\hrulefill
\subsection{ModSqrt Finds x s.t ${x^2 = a \mod p}$}
\vspace{-2ex}
\raggedbottom\lstinputlisting[style=cpp]{cpp/Math/ModSqrt.cpp}
\vspace{-3.2ex}
\hrulefill
